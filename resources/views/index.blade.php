    ...
    <nav class="bg-black text-white p-4">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div class="relative">
                ...
                <input id="search-input" type="text" placeholder="Search..." class="hidden absolute right-0 top-0 px-3 py-1 rounded focus:outline-none focus:ring-2 focus:ring-red-500 text-black">
            </div>
        </div>
